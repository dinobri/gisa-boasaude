...
describe('Exame Management Delete Component', () => {
  let comp: ExameDeleteDialogComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ExameDeleteDialogComponent],
      providers: [NgbActiveModal],
    })
      .overrideTemplate(ExameDeleteDialogComponent, '')
      .compileComponents();
