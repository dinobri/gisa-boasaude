...
describe('Conveniado Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should partial update a Conveniado', () => {
      const patchObject = Object.assign({}, new Conveniado());
    ...
    describe('addConveniadoToCollectionIfMissing', () => {
      ...
      it('should add only unique Conveniado to an array', () => {
        const conveniadoArray: IConveniado[] = [{ id: 123 }, { id: 456 }, { id: 59398 }];
      ...
      it('should return initial array if no Conveniado is added', () => {
        const conveniadoCollection: IConveniado[] = [{ id: 123 }];
        expectedResult = service.addConveniadoToCollectionIfMissing(conveniadoCollection, undefined, null);
        expect(expectedResult).toEqual(conveniadoCollection);
      });
    });
  });
