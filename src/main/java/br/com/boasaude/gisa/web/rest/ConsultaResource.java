...
/**
 * REST controller for managing {@link br.com.boasaude.gisa.domain.Consulta}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ConsultaResource {
    ...
    public ResponseEntity<Consulta> updateConsulta(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, consulta.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/consultas/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Consulta> partialUpdateConsulta(
        ...
        Optional<Consulta> result = consultaRepository
            ...
            .map(existingConsulta -> {
                if (consulta.getSituacao() != null) {
                    existingConsulta.setSituacao(consulta.getSituacao());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, consulta.getId().toString())
        );
    }
