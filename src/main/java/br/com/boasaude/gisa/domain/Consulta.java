...
public class Consulta implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "prestador" }, allowSetters = true)
    @OneToOne
    ...
    public Consulta situacao(SituacaoAtendimento situacao) {
    ...
    public DisponibilidadeConsulta getDisponibilidadeConsulta() {
        return this.disponibilidadeConsulta;
    }

    public void setDisponibilidadeConsulta(DisponibilidadeConsulta disponibilidadeConsulta) {
        this.disponibilidadeConsulta = disponibilidadeConsulta;
    }

    public Consulta disponibilidadeConsulta(DisponibilidadeConsulta disponibilidadeConsulta) {
        this.setDisponibilidadeConsulta(disponibilidadeConsulta);
        return this;
    }
    ...
    public Consulta associado(Associado associado) {
